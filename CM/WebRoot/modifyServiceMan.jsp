		...
		<div id="block">
			...
			<div id="Sright">
				...
				<div class="personalInfo">
					<form action="ModifyBill?type=CreateServiceModify&BillId=${BillId }" method="post">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<input type="text" name="ServiceManId" id="input" value="${ServiceManId }" readonly />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="ServiceManName" id="input" value="${ServiceManName }" readonly />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="ServiceCost" id="input" value="${ServiceCost }"
