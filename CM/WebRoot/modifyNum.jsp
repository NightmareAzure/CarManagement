		...
		<div id="block">
			...
			<div id="Sright">
				...
				<div class="personalInfo">
					<form action="ManagePart?type=Modify" method="post">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<input type="text" name="PartModel" id="input" value="${info.partModel }" readonly/>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="comNum" id="input" value="${info.partNumber }" readonly />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="AddNum" id="input" value="0"/>
								</td>
							</tr>
						</table>
						<p>
