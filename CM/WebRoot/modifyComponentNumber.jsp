		...
		<div id="block">
			...
			<div id="Sright">
				...
				<div class="personalInfo">
					<form action="ModifyBill?type=ModifyPartNumber&BillId=${BillId }" method="post">
						<table border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<td>
									<input type="text" name="partModel" id="input" value="${partModel }" readonly />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="OldpartNum" id="input" value="${partNum }"
										onmouseover="this.focus();this.select();" readonly="readonly"/>
								</td>
							</tr>
							<tr>
								<td>
								...
								<td>
									<input type="text" name="partNum" id="input" value="0"
